...
console.log({ camelCaseKeys: keysToCamelCase({ids: ["0000", "0001", "00002"]}) });
...
const Example = (props) => (<QueryRenderer
      ...
      return <div>
        ...
        {_.map(_.get(props, 'viewer.contacts'), contact =>
          <div key={contact.id}>
            ...
            <div onClick={() => onClick(contact)}><img alt="Avatar" src={contact.avatarImageUrl} /></div>
          </div>
        )}
      </div>;
    }
